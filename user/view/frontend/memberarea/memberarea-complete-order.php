            ...
            <div class="shipping_address2">
                ...
                <form>
                    <table>
                        <tr>
                            <td>
                                <textarea style="margin-bottom: 20px;border: 3px solid black; width: 251px;height: 102px; azimuth: behind; max-height: 102px; min-height: 102px; max-width: 251px;min-width: 251px" value="Nama" onfocus="this.value=(this.value=='Nama') ? '' : this.value;" onblur="this.value=(this.value=='') ? 'Nama' : this.value;"/>
                        ...
                        <tr>
                            <td>
                                <input type="submit" value="" style="background-image: url('<?php include ($dd . "config/url.php"); ?>user/image/cart/submit.gif');width: 107px;height: 22px;border: none;-webkit-border-radius: 10px;-moz-border-radius:10px; -o-border-radius: 10px;cursor: pointer"/>
